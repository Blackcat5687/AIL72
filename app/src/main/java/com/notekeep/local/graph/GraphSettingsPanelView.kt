...
class GraphSettingsPanelView @JvmOverloads constructor(
    ...
    private fun buildFilterContent(body: LinearLayout) {
        ...
        val input = EditText(context).apply {
            setText(state.query)
            hint = "مثال: tag:programming أو path:Projects"
        ...
        body.addView(input)
        body.addView(hintText("أنواع مدعومة: path: · file: · tag: · line: · section: · [خاصية]:قيمة"))
    ...
    private lateinit var ruleColorPicker: GraphColorPickerView
    ...
    private fun buildRuleEditor(body: LinearLayout, ruleId: String) {
        ...
        ruleColorPicker = GraphColorPickerView(context).apply {
            layoutParams = LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT).also { it.bottomMargin = dp(6) }
            setSelectedColor(existing?.color ?: editorSelectedColor)
        }
        body.addView(ruleColorPicker)
        ...
        saveBtn.setOnClickListener {
            ...
            val color = ruleColorPicker.selectedColor
